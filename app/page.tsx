...
const subjects = {
  ...
  Motion: {
    ...
    text: "See how pushing, pulling and force affect the movement of objects.",
    icon: "→",
  },
  Life: {
      ...
      <section className="hero">
        <div className="hero-grid">
          <div className="hero-copy">
            <p className="eyebrow">Bangladeshi curriculum, reimagined</p>
                  ...
                  {subject === "Universe" ? (
                    ...
                    >
                      ...
                      <span className="rotation-label">
                        {solarRunning ? "Tap to pause" : "Tap to rotate"}
                      </span>
                    </button>
                  ) : (
                    <button
...
function Offer({
  ...
  return (
    <article className="offering">
      ...
      <div>
        <p className="kicker">
          {type === "student" ? "Learn your way" : "Teach your way"}
        </p>
